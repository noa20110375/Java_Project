...
public class Game extends Thread {
    ...
    private Image player = new ImageIcon("C:\\Users\\admin\\Desktop\\Java_Project-main\\ShootingGame\\src\\images\\player.png").getImage();
...
//    보스 공격 
    ...
    //보스  움직임 아마
    private ArrayList<EnemyBoss> enemyBosskList = new ArrayList<EnemyBoss>();
    ...
    @Override
    public void run() {
        backgroundMusic = new Audio("src/audio/gameBGM.mid", true);
  ...
  private void enemyBossAppearProcess(){
    	  if (cnt % 150 == 0) {
              enemy = new Enemy(1120, 0);
              enemyList.add(enemy);
          }
      }
    ...
    public void infoDraw(Graphics g) {
        ...
        if (isOver) {
            ...
            g.drawString("TOTAL SCORE : " + score, 295, 450);
